...
Ofreceremos planes de suscripción como el Plan Gratuito, el Plan Premium con descuentos y el Plan Empresarial para maximizar la visibilidad de los espacios. Con ParkEase, facilitamos la vida de los conductores y brindamos oportunidades a los propietarios de espacios de estacionamiento.
...
* Nombre: Paolo Sebastián Padilla Advincula
...
* Nombre: Piero Mendoza Pimentel
  ...
  Como estudiante de Ingeniería de Software, aportaré con mis conocimientos y habilidades al desarrollo del trabajo grupal. 


## 1.2. Solution Profile <a name="12-solution-profile"></a>

“ParkEase” es una aplicación diseñada para resolver la escasez de espacios de estacionamiento en entornos urbanos y mejorar la experiencia de los conductores. Nuestra aplicación permitirá a los usuarios buscar, reservar y pagar por los espacios de estacionamiento de manera eficiente además los propietarios de los espacios podrán registrarse y alquilar a través de la plataforma. El cual ayudará al ahorro de tiempo para los conductores, reducción de la congestión del tráfico y oportunidad de ingresos para los propietarios de espacios de estacionamiento. 
...
* Creemos que al ofrecer a los conductores una plataforma   que les permita encontrar y reservar espacios de estacionamiento de manera eficiente, mejorando su experiencia y ahorrandoles tiempo, lograremos que los conductores valoren la comodidad y estén dispuestos a pagar por nuestro servicio.
...
#### 1.2.2.4. Lean UX Canvas.
![canvas](image-chapter1/Lean%20UX%20Canvas%20Template.jpg)
...
![userpersona-host](Image-chapter2/Laura%20Gutierrez.png)

**Segmento guest**

![userpersona-guest](Image-chapter2/Luis%20Morales.png)
...
En el contexto de la creación y lanzamiento de la aplicación ParkEase, hemos explorado el journey completo de dos usuarios representativos: Laura Gutierrez y Luis Morales. Ambos enfrentan desafíos relacionados con el estacionamiento en entornos urbanos, pero sus necesidades y experiencias son únicas. Este end-to-end journey ilustra cómo ParkEase aborda las necesidades y preocupaciones de estos usuarios desde el inicio de su problema.

![Texto alternativo](Image-chapter2/UserJourneyMap%20-%20Laura%20Gutierrez.png)
![Texto alternativo](Image-chapter2/UserJourneyMap%20-%20Luis%20Morales.png)
...
![Texto alternativo](Image-chapter2/EmpathyMap%20-%20LauraGutierrez.png)
![Texto alternativo](Image-chapter2/EmpathyMap%20-%20LuisMorales.png)
...
![Texto alternativo](Image-chapter2/As-Is-ScenarioMapping%20-%20LauraGutierrez.png)
![Texto alternativo](Image-chapter2/As-Is-ScenarioMapping%20-%20LuisMorales.png)
[Enlace de los As-is-Scenario Map](https://miro.com/app/board/uXjVMozsFEk=/?share_link_id=878207066799)

# Capítulo III: Requirements Specification 
## 3.1. To-Be Scenario Mapping.

![SO-Guest](images-chapter3/SO-Guest.png)
![SO-Host](images-chapter3/SO-Host.png)
...
|US03|Recuperación de la Cuenta|Como User quiero recuperar mi cuenta de la cual me olvide la contraseña o el correo, para evitar crearme otra cuenta.|<p>**Escenario N°1** </p><p>**User no recuerda su contraseña**</p><p>Dado que el User no recuerda su contraseña<br>Entonces deberá seleccionar “¿Olvidaste tu contraseña?”<br>Cuando la seleccione deberá ingresar el correo de la cuenta<br>Entonces se le enviará un código a ese correo.</p><p></p><p>**Escenario N°2**</p><p>**User recibe Código de verificación**</p><p>Dado que el User recibió el código de verificación<br>Cuando coloque el código en la aplicación<br>Entonces se habilita la opción de restablecer la contraseña.</p><p></p><p>**Escenario N°3**</p><p>**User restablece su contraseña**</p><p>Dado que el User puede restablecer su contraseña<br>Cuando escriba dos veces su nueva contraseña</p><p>Entonces deberá seleccionar el botón “Confirmar contraseña”</p><p></p>||
|US04|Métodos de pago|Como User, deseo realizar los pagos por estacionamiento con tarjetas de crédito o débito, u otros servicios de pago como Yape, Plin, Paypal, etc., para facilitar el proceso de pago.|<p>**Escenario N°1**</p><p>**Pago de medicamentos**</p><p>Dado que el User quiere completar su pago por estacionamiento</p><p>Cuando se encuentre en la pestaña de pago</p><p>Entonces podrá visualizar las diversas opciones de pago que ofrece la aplicación y seleccionar la que desee.</p>||
|US05|Historial de pagos|Como User, deseo ver el historial de pagos que tengo respecto a los pagos que hice por un sitio de estacionamiento.|<p>**Escenario N°1**</p><p>**Revisar historial de medicamentos**</p><p>Dado que el User desea revisar los sitios de estacionamiento que pagó anteriormente</p><p>Cuando acceda a la sección de “Perfil” </p><p>Entonces podrá visualizar la opción “Historial de pagos” y al acceder a esta podrá verificar sus pagos.</p>||
|<p>Funcionalidades de Búsqueda</p><p></p><p>US06</p>|Búsqueda de un espacio de estacionamiento|Como User, deseo poder acceder a una barra de búsqueda para encontrar espacios de estacionamiento rápidamente.|<p>**Escenario N°1**</p><p>**Buscar Estacionamiento**</p><p>Dado que el User busca un espacio de estacionamiento</p><p>Cuando entre en la sección "Estacionamientos"</p><p>Entonces podrá utilizar una barra de búsqueda para ingresar el nombre del lugar donde necesita estacionarse. Una vez realizado esto, el mapa mostrará la ubicación del estacionamiento requerido más cerca de la zona con información detallada.</p><p></p><p>**Escenario N°2**</p><p>**Buscar en lista de favoritos**</p><p>Dado que el User desea encontrar un espacio de estacionamiento en su lista de favoritos</p><p>Cuando acceda a la sección “Favoritos” podrá visualizar una barra de búsqueda, donde podrá escribir y buscar el espacio de estacionamiento que anteriormente marcó como favorito</p><p>Entonces se mostrará una lista de sus espacios para estacionarse favoritos.</p>||
|US07|Visualización de la información de un Espacio de Estacionamiento|Como User, quiero observar la información organizada, detallada y clara del espacio de estacionamiento para decidir si ocuparlo o no.|<p>**Escenario N°1**</p><p>**Mostrar ubicación del Espacio de Estacionamiento**</p><p>Dado que el User quiere visualizar espacios de estacionamiento cercanos</p><p>Cuando le dé al botón de búsqueda, y seleccione un espacio de estacionamiento de todas las opciones disponibles</p><p>Entonces aparecerá la dirección exacta del espacio de estacionamiento seleccionado, así como su ubicación en el mapa.</p><p></p><p>**Escenario N°2**</p><p>**Mostrar información de contacto del centro de salud**</p><p>Dado que el User requiere contactarse con el dueño del espacio de estacionamiento</p><p>Cuando le da al botón de búsqueda, y seleccione un espacio de estacionamiento en específico</p><p>Entonces aparecerá información de contacto del del dueño.</p>||
|US08|Filtrado de la búsqueda|Como User, quiero filtrar mi búsqueda de Espacios de Estacionamiento para tener mejores opciones a elegir.|<p>**Escenario N°1**</p><p>**Filtrado de la búsqueda en Espacios de Estacionamiento**</p><p>Dado que el User busca un estacionamiento y quiere que sea conveniente y asequible,</p><p>Cuando utiliza la barra de búsqueda en la parte de la aplicación, le da al botón de filtros y aplica estos,</p><p>Entonces obtiene una lista de estacionamientos cercanos con tarifas económicas y buenas calificaciones, lo que le permite tomar una decisión informada y rápida.</p>||
|<p>Mejora de Soporte al Cliente y Experiencia de Servicio</p><p>US09</p>|Contacto Servicio Técnico|Como User, quiero poder comunicarme con algún experto en la aplicación y sus funciones para qué pueda resolver mis dudas y dificultades durante el uso de esta.|<p>**Escenario N°1: Información de Contacto**</p><p>Dado que el User tiene dudas o problemas que no pueden resolverse con la información proporcionada en la aplicación,</p><p>Cuando acceda a la sección de Soporte técnico</p><p>Entonces podrá encontrar detalles de contacto como número de teléfono y dirección de correo electrónico.</p><p></p><p>**Escenario N°2: Contacto con Técnico**</p><p>Dado que el User dispone de información de contacto,</p><p>Cuando llame al número telefónico proporcionado,</p><p>o Cuando envíe un correo electrónico al destinatario,</p><p>Entonces un miembro del equipo de atención al cliente responderá,</p><p>Y proporcionará respuestas a las preguntas planteadas por el User.</p>||
...
|US21|Obtención de Datos a través de la API|Como Developer quiero tener la capacidad de obtener la lista de Hosts, la lista de Users y los anuncios publicados en la aplicación para poder utilizar estos datos en aplicaciones o servicios externos.|<p>**Escenario 1:** </p><p>**Obtención de la Lista de Hosts**</p><p>Dado que el Developer utiliza la API de ParkEase,</p><p>Cuando realice una solicitud GET a la ruta "/Hosts" en la API,</p><p>Entonces recibirá una lista de Hosts registrados en la plataforma, incluyendo detalles como nombres, direcciones de correo electrónico y detalles de contacto.</p><p></p><p>**Escenario 2:** </p><p>**Obtención de la Lista de Users**</p><p>Dado que el Developer está trabajando con la API de ParkEase,</p><p>Cuando realice una solicitud GET a la ruta "/Users" en la API,</p><p>Entonces recibirá una lista de Users registrados en la aplicación, con información relevante como nombres, direcciones de correo electrónico y detalles de contacto.</p>||
|US22|Obtener Detalles de un Host por ID|Como developer, quiero obtener los detalles de un Host específico a través de su identificación única (ID).|<p>**Escenario 1:**</p><p>**Obtener Detalles de un Host por ID**</p><p>Dado que el Developertiene el ID de un Host,</p><p>Cuando realice una solicitud GET a la ruta "/Hosts/{ID}" en la API,</p><p>Entonces recibirá los detalles del Host correspondiente.</p><p></p><p>**Escenario 2:**</p><p>` `**Obtención de la Lista de Users por ID**</p><p></p><p>Dado que el Developer tiene el ID de un User,</p><p>Cuando realice una solicitud GET a la ruta "/Users/{ID}" en la API,</p><p>Entonces recibiré los detalles del User correspondiente.</p>||
|US23|Obtener Estadísticas de Uso Detalladas|Como Developer, quiero obtener estadísticas de uso detalladas de la plataforma para evaluar el rendimiento y la eficacia de la aplicación.|<p>**Escenario 1:**</p><p>**Dado que deseo obtener estadísticas de uso detalladas,**</p><p>Dado que el Developer realice una solicitud GET a la ruta "/stadistics/details" en la API,</p><p>Entonces recibirá un informe completo que incluye datos específicos, como el número total de Users registrados, el promedio de tiempo que los Users pasan en la aplicación y otros indicadores clave que le ayudarán a comprender mejor el rendimiento de la plataforma.</p><p></p><p>**Escenario 2:** </p><p>**Obtención de Estadísticas de Uso por Región Geográfica**</p><p>Dado que el Developer quiere entender mejor cómo se utiliza la aplicación en diferentes lugares,</p><p>Cuando realice una solicitud GET a la ruta "/stadistics/places en la API,</p><p>Entonces recibirá datos detallados sobre el uso de la aplicación en lugares específicos, incluyendo información sobre la cantidad de Users, reservas y anuncios en cada área geográfica.</p>||
...
![ImpactMapping1](images-chapter3/ImpactMapping1.png)
![ImpactMapping2](images-chapter3/ImpactMapping2.png)

## 3.4. Product Backlog. 

|**#Orden**|**User Story ID**|**Título**|**Descripción**|**Story Points**|
| :- | :- | :- | :- | :- |
|1|US13|Compra de Suscripciones|Como usuario, deseo tener la opción de comprar suscripciones dentro de la aplicación para acceder a características premium y beneficios exclusivos. Esto me permitirá disfrutar de una experiencia mejorada mientras uso la aplicación.|3|
|2|US15|Métodos de pago|Como usuario, deseo realizar los pagos por estacionamiento con tarjetas de crédito o débito, u otros servicios de pago como Yape, Plin, Paypal, etc., para facilitar el proceso de pago.|5|
|3|US07|Visualización de la información de un Espacio de Estacionamiento|Como usuario, quiero observar la información organizada, detallada y clara del espacio de estacionamiento para decidir si ocuparlo o no.|3|
|4|<p>US06</p><p></p>|Búsqueda de un espacio de estacionamiento|Como usuario, deseo poder acceder a una barra de búsqueda para encontrar espacios de estacionamiento rápidamente.|2|
|5|US01|Creación de cuenta|Como usuario quiero crear una cuenta nueva desde el aplicativo para poder acceder a todos los servicios que ofrece.|2|
|6|US02|Inicio de Sesión|Como usuario quiero iniciar sesión con la cuenta que cree para poder acceder a las funciones de la aplicación.|2|
|7|US03|Recuperación de la Cuenta|Como usuario quiero recuperar mi cuenta de la cual me olvide la contraseña o el correo, para evitar crearme otra cuenta.|3|
|8|US05|Historial de pagos|Como usuario, deseo ver el historial de pagos que tengo respecto a los pagos que hice por un sitio de estacionamiento.|3|
|9|US19|Configuración de Precios|Como propietario, quiero poder establecer precios para mis espacios de estacionamiento, ya sea por hora, día o semana, y tener la flexibilidad de ajustar los precios según la demanda.|5|
|10|US19|Gestión de Disponibilidad|Como propietario, quiero poder definir la disponibilidad de mis espacios de estacionamiento, estableciendo horarios específicos y días de la semana en los que están disponibles.|5|
|11|US20|Visualización de Reservas|Como propietario, quiero poder ver las reservas realizadas para mis espacios de estacionamiento, incluyendo la fecha, hora y detalles del conductor.|5|
|12|US21|Obtención de Datos a través de la API|Como Developer quiero tener la capacidad de obtener la lista de propietarios, la lista de usuarios y los anuncios publicados en la aplicación para poder utilizar estos datos en aplicaciones o servicios externos.|8|
|13|US22|Obtener Detalles de un Propietario por ID|Como developer, quiero obtener los detalles de un propietario específico a través de su identificación única (ID).|8|
|14|US15|Actualizar Métodos de Pago|Como usuario, quiero ser capaz de actualizar los medios de pago en mi perfil para poder añadir, actualizar o eliminar distintos métodos de pago que prefiera utilizar en la aplicación.|3|
|15|US14|Editar información del perfil|Como usuario, quiero tener la opción de editar la información de mi perfil para mantenerla actualizada.|2|
|16|US10|Tutorial de uso de la Aplicación|Como nuevo usuario, deseo recibir instrucciones claras y pop-ups informativos al utilizar la aplicación por primera vez, para entender las funcionalidades y así aprender a utilizar la aplicación de manera efectiva.|2|
|17|US11|Acceso a Preguntas Frecuentes|Como usuario, deseo acceder a la sección de preguntas frecuentes y sus respectivas respuestas. Esto me permitirá resolver cualquier duda que tenga y obtener información adicional sobre la aplicación.|2|
|18|US09|Contacto Servicio Técnico|Como usuario, quiero poder comunicarme con algún experto en la aplicación y sus funciones para qué pueda resolver mis dudas y dificultades durante el uso de esta.|3|
|19|US12|Visualización y confirmación de pago|Como usuario, quiero poder visualizar el resumen de mi pago por el espacio de estacionamiento antes de confirmar la transacción. Esto me permitirá revisar los detalles y asegurarme de que la información sea correcta antes de realizar el pago.|3|
|20|US16|Registro de Propietario|Como propietario de un espacio de estacionamiento, quiero poder registrarme en la plataforma ParkEase proporcionando información básica sobre mi espacio y mis datos de contacto.|5|
|21|US17|Creación de Listados de Espacios|Como propietario, quiero poder crear listados para mis espacios de estacionamiento, incluyendo detalles como la ubicación, el tipo de espacio, las tarifas y la disponibilidad.|5|
|22|US24|Visualizar información de la Startup|Como visitante del segmento Guest/Host, quiero poder acceder a una sección "Sobre Nosotros" para obtener información detallada sobre la empresa ParkEase.|1|
|23|US25|Visualizar información para Propietarios|Como visitante del segmento Host, quiero acceder a una sección que explique las ventajas de utilizar ParkEase como plataforma para gestionar mis espacios de estacionamiento.|1|
|24|US26|Visualizar información para Usuarios cliente|Como visitante del segmento Guest, quiero acceder a una sección que explique cómo ParkEase facilita la búsqueda y reserva de espacios de estacionamiento.|1|
|25|US27|Visualización de Planes de Suscripción|Como visitante del segmento Guest/Host, quiero acceder a información sobre los diferentes planes de suscripción ofrecidos por ParkEase.|2|
